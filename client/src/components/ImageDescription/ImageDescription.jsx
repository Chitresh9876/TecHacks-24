...
const ImageDescription = () => {
  return (
    <div>
      <Stack direction="row" justifyContent="space-evenly" mt={5} alignItems={"center"}> 
        <div className={styles.image}>
          <img src={IMG1} alt="air image" />
        </div>
        <Card sx={{ maxWidth: 600, height: "20rem", boxShadow:"none"}} mt={5}>
          <CardActionArea>
            ...
            Lizard
              ...
              <Typography variant="body2" color="text.secondary" fontSize={20} fontWeight={500}>
      ...
      <Stack direction="row-reverse" justifyContent="space-evenly" mt={5} alignItems={"center"}> 
        <div className={styles.image}>
          <img src={IMG2} alt="air image" />
        </div>
        <Card sx={{ maxWidth: 600, height: "20rem", boxShadow:"none"}} mt={5}>
          <CardActionArea>
            <CardContent>
